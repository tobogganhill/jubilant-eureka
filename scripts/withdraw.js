...
async function main() {
	...
	const contractAddress = '0xbe138C9f4540AAffB6477F0Aa6c7C317B546C5A2';
...
// Recommended pattern to be able to use async/await everywhere and properly handle errors.
main()
	.then(() => process.exit(0))
	.catch((error) => {
		console.error(error);
